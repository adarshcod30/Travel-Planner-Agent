...
1. Budget realism. Compare the budget total and the hotel nightly prices with what the destination actually costs at the stated budget level for the stated number of travelers and days. A mid-range hotel in a major city is not 30 USD a night, and a budget trip does not total 6000 USD for four days. Check that the hotel line covers the shortlisted hotels for the number of nights (a trip of N days is N-1 nights) and that the category lines add up to the stated total.
